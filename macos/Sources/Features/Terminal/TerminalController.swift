...
class TerminalController: BaseTerminalController, TabGroupCloseCoordinator.Controller {
    ...
    override func windowDidLoad() {
        ...
        // Phanttom: [sidebar | terminal] split (see TerminalController+PhanttomSidebar).
        window.contentView = installPhanttomSidebar(terminalContainer: container)
