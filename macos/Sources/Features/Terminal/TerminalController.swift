...
class TerminalController: BaseTerminalController, TabGroupCloseCoordinator.Controller {
    ...
    override func windowDidLoad() {
        ...
        // unless the window style is incompatible; see
        // TerminalController+PhanttomSidebar.swift.
        if !phanttomInstallSidebar(in: window, terminal: container, config: config) {
